...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.armor_class.setProperty("value", 10)
        ...
        self.result.setGeometry(QtCore.QRect(300, 180, 121, 51))
        font = QtGui.QFont()
        ...
        self.hit_chance.setGeometry(QtCore.QRect(430, 180, 81, 51))
        font = QtGui.QFont()
        font.setFamily("Rubik SemiBold")
        font.setPointSize(36)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.flag_gwm.setText(_translate("MainWindow", "PAM/SharpShooter"))
