...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.result.setGeometry(QtCore.QRect(300, 180, 81, 51))
        font = QtGui.QFont()
        ...
        self.hit_chance.setGeometry(QtCore.QRect(390, 180, 91, 51))
        font = QtGui.QFont()
        font.setFamily("Rubik SemiBold")
        font.setPointSize(36)
        font.setBold(True)
        ...
        self.history_to_avg = QtWidgets.QSpinBox(self.centralwidget)
        self.history_to_avg.setEnabled(True)
        self.history_to_avg.setGeometry(QtCore.QRect(490, 210, 51, 22))
        self.history_to_avg.setMinimum(1)
        self.history_to_avg.setMaximum(99)
        self.history_to_avg.setProperty("value", 7)
        self.history_to_avg.setObjectName("history_to_avg")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(490, 180, 98, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.history_to_avg.setToolTip(_translate("MainWindow", "Select Armor class (or leave on \'-1\' to simular for all classes)"))
        self.history_to_avg.setStatusTip(_translate("MainWindow", "Select number of rolls to include for hitrate %"))
