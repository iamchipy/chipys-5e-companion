...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.result.setGeometry(QtCore.QRect(300, 180, 71, 51))
        font = QtGui.QFont()
        ...
        self.dice_log.setGeometry(QtCore.QRect(300, 10, 241, 151))
        ...
        self.hit_chance.setGeometry(QtCore.QRect(380, 180, 111, 51))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(36)
        font.setBold(True)
        ...
        self.label_5.setGeometry(QtCore.QRect(390, 160, 98, 20))
        self.label_5.setObjectName("label_5")
        self.history_to_use = QtWidgets.QSpinBox(self.centralwidget)
        self.history_to_use.setEnabled(True)
        self.history_to_use.setGeometry(QtCore.QRect(500, 200, 41, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.history_to_use.setFont(font)
        self.history_to_use.setMinimum(1)
        self.history_to_use.setMaximum(99)
        self.history_to_use.setProperty("value", 7)
        self.history_to_use.setObjectName("history_to_use")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(500, 180, 98, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.history_to_use.setToolTip(_translate("MainWindow", "Select Armor class (or leave on \'-1\' to simular for all classes)"))
        self.history_to_use.setStatusTip(_translate("MainWindow", "Select number of rolls to include for hitrate %"))
